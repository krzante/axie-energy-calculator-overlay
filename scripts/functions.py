# from tkinter import * #used in tab2
# from tkinter import messagebox #used in tab3
# import numpy as np #used in tab1 tab4
# from asteval import Interpreter # Used in tab2
# import json # Used in tab2 tab4

# aeval = Interpreter() #used in tab2
